<div class="container-fluid mt-5">
    <hr>
    <span class="badge rounded-pill text-bg-warning mb-3 fw-bold text fs-5" style="height: 2.3rem;">Pending</span>
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            $query = "SELECT * FROM pekerjaan WHERE nipp = '$nipp' AND status = 'Pending' ORDER BY 
              CASE 
    ...
    <?= $lateBadge; ?>
            ...
            <?php else: ?>
            <tr>
                <td colspan="9" class="text-center">Tidak ada pekerjaan dengan status 'Pending' ditemukan untuk NIPP
                    ini.</td>
            </tr>
            <?php endif; ?>
        </tbody>
